      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-amber-500/50 transition-colors">
            ...
            <h4 className="text-lg font-bold text-white mb-2">カウンターシステム</h4>
            <p className="text-slate-400 text-sm leading-relaxed">
              障害物をギリギリで回避（Just Dodge）すると、その障害物が後方へ弾き飛ばされ、ボスにダメージを与えます。
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-slate-900 rounded-2xl overflow-hidden border border-slate-700">
          <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-700">
            <div className="p-8 hover:bg-slate-800/50 transition-colors relative group">
              ...
              <p className="text-slate-400 text-sm">パワータイプ。タルやバナナを投げてくる初期の脅威。</p>
            </div>
            <div className="p-8 hover:bg-slate-800/50 transition-colors relative group">
              ...
              <p className="text-slate-400 text-sm">スピードタイプ。骨や岩を高速で投げ、猛スピードで追いかける。</p>
            </div>
            <div className="p-8 hover:bg-slate-800/50 transition-colors relative group">
              ...
              <p className="text-slate-400 text-sm">フライトタイプ。空を飛び、火の玉（Fireball）を吐く最強の敵。</p>
            </div>
          </div>
        </div>
        ...
        <ul className="space-y-4">
          ...
          <li className="flex items-start">
            ...
            <div className="ml-4">
              ...
              <span className="text-slate-400 text-sm">連続回避成功でスコア倍率が上昇。ハイリスク・ハイリターン。</span>
            </div>
          </li>
          <li className="flex items-start">
            ...
            <div className="ml-4">
              ...
              <span className="text-slate-400 text-sm">ハートは3つ。0になるとゲームオーバー。回復手段は限られている...。</span>
            </div>
          </li>
        </ul>
      </div>
